  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/categories"
          element={<Categories addToCart={addToCart} siteDiscount={siteDiscount} />}
        />
        <Route
          path="/categories/:id"
          element={<Categories addToCart={addToCart} siteDiscount={siteDiscount} />}
        ...
        <Route
          path="/products"
          element={<AllProducts addToCart={addToCart} siteDiscount={siteDiscount} />}
        />
        <Route
          path="/deals"
          element={<Deals addToCart={addToCart} siteDiscount={siteDiscount} />}
        />
